...
def _run_context(run_metadata: pd.DataFrame) -> dict[str, object]:
    ...
    return {
        ...
        "optimizer_return_unit": row.get("optimizer_return_unit"),
        "calibration_enabled": row.get("calibration_enabled"),
        "calibration_method": row.get("calibration_method"),
        "calibration_target": row.get("calibration_target"),
        "calibration_model_version": row.get("calibration_model_version"),
        "calibration_status": row.get("calibration_status"),
        "calibration_trained_through_date": row.get("calibration_trained_through_date"),
        "calibration_observations": row.get("calibration_observations"),
        "calibration_mae": row.get("calibration_mae"),
        "calibration_rmse": row.get("calibration_rmse"),
        "calibration_rank_ic": row.get("calibration_rank_ic"),
